...
public class Editnonmajor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editnonmajor);

        recyclerView = (RecyclerView) findViewById(R.id.nonmajorsubjectlist);
        ...
        logindata.addProperty("id",SharedPreference.getAttribute(Editnonmajor.this, "id"));

        RetrofitCommunication retrofitCommunication = new RetrofitConnection().init();
        Call<JsonObject> majorlist = retrofitCommunication.compltednonmajorsubject(logindata);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Editnonmajor.this, EditInfoActivity.class);
                intent.putExtra("deletenonmajor", Resultmajor);
