...
public class TimetableOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "이전 없음", Toast.LENGTH_LONG).show();
            }
        });
        forward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TimetableOne.this, TimetableTwo.class);
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.body().get("code").getAsInt() == 200) {
                    ...
                    if(rawdata1.contains("&")){
                        ...
                        AlertDialog.Builder alert = new AlertDialog.Builder(TimetableOne.this);
                        alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                Intent intent = new Intent(TimetableOne.this, TimetableActivity.class);
                                startActivity(intent);
                                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                                finish();     //닫기
                            }
                        });
                        alert.setMessage("해당 학기/해당 옵션에 추천 시간표가 없습니다.");
                        alert.show();
                    }
    ...
    public void Getschedule(String income, Schedule schedule, Schedule schedule2, Schedule schedule3){
        ...
        Log.d("시간 길이:", Integer.toString(length));
